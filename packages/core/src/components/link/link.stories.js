...
const inlineLink = `
  <a href="https://hds.hel.fi" class="hds-link" aria-label="Inline link. Opens in external domain">
    <span>Inline link</span><i class="hds-icon hds-icon--link-external" aria-hidden="true"></i></a>
`

const inlineLinkWithIconClasses = `
  <a href="https://hds.hel.fi" class="hds-link hds-icon--document hds-icon-start--document" aria-label="Document link. Opens in external domain">Document link</a>
`
...
export const openInNewTabLink = () => `
  <a href="https://hds.hel.fi" class="hds-link hds-link--medium" rel="noopener" target="_blank" aria-label="Link that opens in a new tab. Opens in a new tab. Opens in external domain">
    <span>Link that opens in a new tab</span><i class="hds-icon hds-icon--link-external" aria-hidden="true"></i>
  </a>
`
