...
WithCustomTheme.args = {
  theme: {
    ...
    '--menu-item-background-default': 'var(--color-summer)',
    '--menu-item-background-hover': 'var(--color-summer-light)',
    '--menu-item-background-selected': 'var(--color-summer-light)',
    '--menu-item-background-selected-hover': 'var(--color-summer-light)',
    '--menu-item-background-disabled': 'var(--color-black-30)',
    '--menu-item-background-disabled-hover': 'var(--color-black-30)',
