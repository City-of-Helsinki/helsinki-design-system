...
WithCustomTheme.args = {
  theme: {
    ...
    '--menu-item-background-default': 'var(--color-copper)',
    '--menu-item-background-hover': 'var(--color-copper-light)',
    '--menu-item-background-selected': 'var(--color-copper-light)',
    '--menu-item-background-selected-hover': 'var(--color-copper-light)',
    ...
    '--checkbox-border-color-selected': 'var(--color-copper-dark)',
    '--checkbox-border-color-selected-hover': 'var(--color-bus-dark)',
    '--checkbox-border-color-selected-focus': 'var(--color-black)',
    '--checkbox-border-color-unselected': 'var(--color-copper-light)',
    '--checkbox-border-color-unselected-hover': 'var(--color-copper-dark)',
    '--checkbox-border-color-unselected-focus': 'var(--color-copper)',
    ...
    '--text-input-border-color-default': 'var(--color-coat-of-arms)',
    '--text-input-border-color-hover': 'var(--color-coat-of-arms-light)',
    '--text-input-border-color-focus': 'var(--color-coat-of-arms)',
    ...
    '--show-all-border-color-disabled': 'var(--color-black-50)',
    ...
    '--show-all-color-disabled': 'var(--color-black-50)',
    ...
    '--clear-all-border-color-disabled': 'var(--color-black-50)',
    ...
    '--clear-all-color-disabled': 'var(--color-black-50)',
