...
export const Default = () => <ErrorSummary label="Form contains following errors">{defaultErrors}</ErrorSummary>;

export const Large = () => (
  <ErrorSummary label="Form contains following errors" size={ErrorSummarySize.Large}>
    {defaultErrors}
  </ErrorSummary>
);
