    ...
    it('Source for the numeral must be set as "numberIndicator" or "selectionCount"', () => {
      expect(
        getNumberedVariationsTextKey(
          ...
          { textProvider, selectedOptions: noSelectedOptions } as ModularOptionListMetaData,
          'selectionCount',
          {
            numberIndicator: 1,
          },
      ...
      expect(
        getNumberedVariationsTextKey(
          'selectedOptionsCount',
          { textProvider, selectedOptions: oneSelectedOption } as ModularOptionListMetaData,
          'selectionCount',
          {
            numberIndicator: 0,
          },
      ...
      expect(
        getNumberedVariationsTextKey(
          'selectedOptionsCount',
          { textProvider, selectedOptions: multipleSelectedOptions } as ModularOptionListMetaData,
          'selectionCount',
          {
            numberIndicator: 0,
          },
