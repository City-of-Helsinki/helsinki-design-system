...
import { FilterFunction, Group, Option, ModularOptionListDataHandlers } from './types';
...
describe('utils', () => {
  ...
  describe('createOnClickListener creates object with an onClick function which triggers a changeEvent', () => {
    const dataHandlers = mockUseModularOptionListDataHandlersContents as ModularOptionListDataHandlers;
  ...
  describe('propsToGroups converts given data in ModularOptionListProps format to ModularOptionListData', () => {
  ...
  describe('updateSelectedOptionsInGroups sets given options selected and others unselected', () => {
    ...
    it('Data can be ModularOptionListProps["groups"] with string options', () => {
    ...
    it('Data can be ModularOptionListProps["groups"] with option objects and selectedOption can be a string value or an object', () => {
      expect(
    ...
    it('Data can be ModularOptionListProps["groups"] with a string value', () => {
      expect(updateSelectedOptionsInGroups([{ options, label: 'Group label' }], options[0])).toMatchObject([
        {
          options: [{ ...validateOption(options[0]), selected: true }, validateOption(options[1])],
        },
    ...
    it('Data can be ModularOptionListData["groups"] option objects', () => {
