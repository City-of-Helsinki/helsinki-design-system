...
import { GetModularOptionListProps, initTests, mockedContainer, testUtilAfterAll, testUtilBeforeAll } from '../../testUtil';
...
describe('useFocusHandling', () => {
  ...
  const simplerProps: GetModularOptionListProps = {
    ...defaultProps,
    open: true,
    multiSelect: false,
    groups: false,
