...
export const WithToolTip = (args) => (<Checkbox id="with-tooltip" label="Label" {...args}/>);
WithToolTip.args = {
  tooltipText: 'tooltip text for checkbox',
  tooltipLabel: 'tooltip aria label for checkbox',
  tooltipButtonLabel: 'tooltip aria label'  
}
