...
import { ModularOptionListDataHandlers } from '../../types';
import { useModularOptionListDataHandlers } from '../../hooks/useModularOptionListDataHandlers';
import { getTextKey } from '../../texts';

export type MultiSelectGroupLabelProps = ModularOptionListItemProps & {
...
export function MultiSelectGroupLabel(props: MultiSelectGroupLabelProps) {
  const elementProps = createMultiSelectGroupLabelProps(props, useModularOptionListDataHandlers());
