...
const createMultiSelectItemProps = ({
  ...
  getOptionId,
  isInGroup,
}: ModularOptionListItemProps & { isInGroup: boolean }): MultiSelectOptionProps => {
...
export function MultiSelectOption(props: ModularOptionListItemProps & { isInGroup: boolean }) {
  const elementProps = createMultiSelectItemProps(props);
  return <MultiSelectOptionElement {...elementProps} key={elementProps.label} />;
}

export const MemoizedMultiSelectOption = memo<ModularOptionListItemProps & { isInGroup: boolean }>(
  MultiSelectOption,
