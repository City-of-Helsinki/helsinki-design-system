...
export const defaultTexts: Record<SupportedLanguage, Texts> = {
  en: {
    ...
    tagsClearAllButtonAriaLabel_multiple: 'Tyhjennä kaikki {{selectionCount}} valittua vaihtoehtoa.',
    tagsRemaining_one: 'Yksi valinta jäljellä.',
    tagsRemaining_multiple: 'Jäljellä on {{selectionCount}} valintaa.',
    ...
    // no _one _multiple needed for this. There must be 2+ options if some tags are hidden.
    tagsShowAllButtonAriaLabel: 'Näytä kaikki {{selectionCount}} valittua vaihtoehtoa.',
