...
export type SearchFieldProps = Omit<SearchPropsType & AcceptedNativeDivProps, 'onChange' | 'value'> & {
  ...
  const metaData = useMemo((): SearchMetaData => {
    ...
    return {
      ...
      refs: {
        ...
        searchInput: typeof ref === 'function' ? createRef<SearchInputHandle>() : ref || createRef<SearchInputHandle>(),
...
export const Search = ({ historyId, ref, ...rest }: SearchProps) => {
  return (
