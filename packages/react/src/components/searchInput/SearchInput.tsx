import React, { KeyboardEvent, useState, useRef, Ref, useEffect } from 'react';
...
const SearchInputComponent = React.forwardRef(
  <SuggestionItem,>(
    {
      className,
...
export const SearchInput = (SearchInputComponent as unknown) as <SuggestionItem>(
  props: SearchInputProps<SuggestionItem> & { ref?: Ref<HTMLFormElement> },
) => JSX.Element;
