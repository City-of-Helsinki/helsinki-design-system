...
describe('<TimeInput /> spec', () => {
  ...
  it('should update time value when numeric hours and minutes are typed', async () => {
    ...
    await userEvent.type(screen.getByLabelText('Hours', { selector: 'input' }), '12');
    await userEvent.type(screen.getByLabelText('Minutes', { selector: 'input' }), '00');
  ...
  it('should remove colon from time value when both minutes and hours are missing', async () => {
    ...
    await userEvent.type(screen.getByLabelText('Hours', { selector: 'input' }), '{backspace}');
    await userEvent.type(screen.getByLabelText('Minutes', { selector: 'input' }), '{backspace}');
