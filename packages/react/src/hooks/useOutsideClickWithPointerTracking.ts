...
/*
  Simple hook that calls given callback when click event happens outside given element
*/
function useOutsideClickWithPointerTracking({
  ref,
  callback,
  usePointerDownEvent,
}: {
...
export default useOutsideClickWithPointerTracking;
