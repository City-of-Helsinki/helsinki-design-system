...
- <Link size="M" href="https://www.abstract.com/" external>Abstract</Link> is a <strong>design collaboration and version and management tool</strong> that enables designers to share Sketch files and libraries easily. By leveraging and extends the technology of Git, Abstract provides design teams with a lightweight workflow and stable tools so designers can work together with confidence.
