...
<Accordion 
  ...
  HDS ensures that its components are accessible. This does not mean that a project build with these components is accessible automatically. The project needs to make sure that the components are used in a correct way and the content is accessible. Using HDS components takes some workload away from your project and lets your project focus on project-specific accessibility. You can read more about the topic in the <Link size="M" href="/about/accessibility/hds-accessibility#accessibility-in-projects-using-hds">About - HDS Accessibility section</Link>.
</Accordion>
...
<Accordion 
  ...
  Please contact our team with any of the channels listed on the <Link size="M" href="/about/support">Support page</Link>. You can also open an issue in <Link size="M" href="https://github.com/City-of-Helsinki/helsinki-design-system/issues">GitHub</Link>. 
