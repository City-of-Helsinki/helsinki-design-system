...
<Accordion 
  ...
  Please refer to <Link size="M" href="https://helsinkisolutionoffice.atlassian.net/wiki/spaces/DD/pages/296058881/Using+Helsinki+Grotesk+fonts" external>the internal font documentation in Confluence</Link>. If you do not have access to Confluence, ask your project’s city employee contact.
</Accordion>
