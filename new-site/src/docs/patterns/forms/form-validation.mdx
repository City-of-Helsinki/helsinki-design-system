...
<Image src="/images/patterns/form/validation/form-states-error@2x.png" alt="Form control error state" style="max-width:376px;" viewable />
...
<Image src="/images/patterns/form/validation/form-validation-message-success@2x.png" alt="Form control success state" style="max-width:376px;" viewable />
...
<Image src="/images/patterns/form/validation/form-validation-message-info-1@2x.png" alt="Info message example; the input value was edited" style="max-width:376px;" viewable /><br />
...
<Image src="/images/patterns/form/validation/form-validation-message-info-2@2x.png" alt="Info message example; the input was filled automatically" style="max-width:376px;" viewable /><br />
...
<Image src="/images/patterns/form/validation/error-summary@2x.png" alt="Error summary component" style="max-width:482px;" viewable />
...
<Image src="/images/patterns/form/validation/validation-pattern-example@2x.png" alt="Validation summary example" style="max-width:432px;" viewable />
...
<Image src="/images/patterns/form/validation/multiple-fields-validation@2x.png" alt="Showing error messages of multiple input fields" style="max-width:482px;" viewable />
