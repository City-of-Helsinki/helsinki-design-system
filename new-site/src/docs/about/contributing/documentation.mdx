---
slug: '/about/contributing/documentation'
title: 'Documentation'
---
...
- Documentation site styles take care of most of the accessibility issues. You mostly need to ensure that heading levels are used semantically (refer to [HDS typography documentation](/elements/design-tokens/typography)) and external links are correctly visualized (you can use the HDS provided <Link size="M" href="https://github.com/City-of-Helsinki/helsinki-design-system/blob/master/site/src/components/Link.js" external>Link component</Link>.