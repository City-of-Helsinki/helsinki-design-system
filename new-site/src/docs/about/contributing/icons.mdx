...
<Image src="../../images/about/icontypes.jpg" alt="A selection of icons for different uses in HDS" style="max-width:600px;" viewable />
...
<Image src="../../images/about/basicshapes.jpg" alt="Basic shapes are the best starting point for icon creation" style="max-width:600px;" viewable />
...
## Dimensions
<Image src="../../images/about/dimensions.jpg" alt="The icon size variants used by HDS" style="max-width:600px;" viewable />
...
<Image src="../../images/about/keyshapes_orthogonals.jpg" alt="Left: Keyshapes. Right: Orthogonal. The building blocks of an effective icon grid." style="max-width:600px;" viewable />
...
<Image src="../../images/about/masking.jpg" alt="Basic steps to masking" style="max-width:600px;" viewable />
...
<Image src="../../images/about/pixelgrid.jpg" alt="A simple pixel grid for making icons." style="max-width:600px;" viewable />
...
<Image src="../../images/about/icongrid.jpg" alt="A simple icon grid for making icons." style="max-width:600px;" viewable />
...
<Image src="../../images/about/safearea_trimarea.jpg" alt="The difference between safe area and trim area explained." style="max-width:600px;" viewable />
...
<Image src="../../images/about/AlertCircle_Fill_cropped.gif" alt="How to make the Alert Circle icon using basic shapes." style="max-width:600px;" viewable />
