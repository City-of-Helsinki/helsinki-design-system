...
| ----------------- | -------: | --------: | ------------------------------------------------------------------------------------------------------------------------------------------ |------------------------------------------------------------------------------------------------------------------------------------------- |
| **Heading XL**    | 52px     | 3.25rem   | <h1 class="heading-xxl" style={{fontSize: 'var(--fontsize-heading-xl)', marginTop:'var(--spacing-2-xs)', marginBottom:'var(--spacing-2-xs)'}}>Heading h1</h1>  |                                                                                                                                            |
