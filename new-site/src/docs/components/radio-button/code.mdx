...
<div>
  ...
  <div class="hds-radio-button">
    <input type="radio" id="radio2" name="example2" class="hds-radio-button__input" checked />
    <label for="radio2"  class="hds-radio-button__label">Label</label>
  </div>

  <div class="hds-radio-button">
    <input type="radio" id="radio3" name="example3" class="hds-radio-button__input" disabled />
