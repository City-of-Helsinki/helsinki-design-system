...
See the <Link size="M" href="/foundation/visual-assets/logo">logo visual asset documentation</Link> for more information about principles of using the City of Helsinki logo.
