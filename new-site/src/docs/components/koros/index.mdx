...
You can read more about using Koros in <Link size="M" href="https://brand.hel.fi/en/wave-motifs/" external>Helsinki Visual Identity Guidelines - Wave motifs</Link>.
...
The dense Koro variant introduces a smaller wave size with the same shapes. You can choose either the Default or the Dense variant for your project. Read more about Koro usage on the [HDS Foundation - Wave motifs page](/foundation/visual-assets/wave-motifs).
