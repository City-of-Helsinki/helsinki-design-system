---
slug: '/elements/components/text-input/code'
...
<div style="max-width:320px;">
  ...
  <div class="hds-text-input" style="margin-top:var(--spacing-s);">
    ...
    <div class="hds-text-input__input-wrapper">
      <input id="input-disabled" class="hds-text-input__input" type="text" value="Text input value" disabled />
    </div>
    <span class="hds-text-input__helper-text">Assistive text</span>
  </div>

  <div class="hds-text-input hds-text-input--invalid" style="margin-top:var(--spacing-s);">
    <label for="input-invalid" class="hds-text-input__label">
      Label
    </label>
    <div class="hds-text-input__input-wrapper">
      <input id="input-invalid" class="hds-text-input__input" type="text" value="Text input value" />
    </div>
