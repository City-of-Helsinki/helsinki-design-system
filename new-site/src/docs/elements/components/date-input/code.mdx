...
### Properties
Note! You can find the full list of properties in the <Link size="M" href="/storybook/react/?path=/story/components-dateinput--default" external>React Storybook.</Link>
