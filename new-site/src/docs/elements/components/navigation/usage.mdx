...
import { Navigation, Link } from 'hds-react';
...
- Navigation component is built to follow HDS [breakpoint tokens](/elements/design-tokens/breakpoints). While it is recommended to follow HDS breakpoint tokens, you may alter navigation width to fit your service's needs.
