---
slug: '/elements/components/time-input/usage'
title: 'TimeInput - Usage'
---
...
- Time is often asked alongside a date. Use the [HDS date input](/elements/components/date-input) for asking dates.
...
It is better to use [HDS Select](/elements/components/dropdown#select-single-selection) for selecting times when the time format is very strict or when there are only a set amount of time slots available.
