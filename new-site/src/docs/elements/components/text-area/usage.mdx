---
slug: '/elements/components/text-area/usage'
...
- Use a text area when multiples lines of text is expected. For single line inputs, use a [TextInput component](/elements/components/text-input).
