...
- It is recommended to use scaling methods HDS suggests for each breakpoint (<Link size="M" href="#">see Breakpoints token table</Link>). However, it is allowed to use different scaling methods if it works better for the service.
