  ...
  const componentData = [
    {
      ...
      href: withPrefix('/components/accordion'),
    },
    {
      name: 'Button',
    ...
    },
    {
      ...
      href: withPrefix('/components/card'),
    },
    {
      name: 'Checkbox',
      ...
      href: withPrefix('/components/checkbox'),
    },
    {
      name: 'DateInput',
      ...
      href: withPrefix('/components/date-input'),
    },
    {
      name: 'Dialog',
      ...
      href: withPrefix('/components/dialog'),
    },
    {
      name: 'Dropdown',
      ...
      href: withPrefix('/components/dropdown'),
    },
    {
      name: 'Fieldset',
      ...
      href: withPrefix('/components/fieldset'),
    },
    {
      name: 'FileInput',
      ...
      href: withPrefix('/components/file-input'),
    },
    {
      name: 'Footer',
      ...
      href: withPrefix('/components/footer'),
    },
    {
      name: 'Icon',
      ...
      href: withPrefix('/components/icon'),
    },
    {
      name: 'Koros',
      ...
      href: withPrefix('/components/koros'),
    },
    {
      name: 'Link',
      ...
      href: withPrefix('/components/link'),
    },
    {
      name: 'Linkbox',
      ...
      href: withPrefix('/components/linkbox'),
    },
    {
      name: 'LoadingSpinner',
      ...
      href: withPrefix('/components/loading-spinner'),
    },
    {
      name: 'Logo',
      ...
      href: withPrefix('/components/logo'),
    },
    {
      name: 'Navigation',
      ...
      href: withPrefix('/components/navigation'),
    },
    {
      name: 'Notification',
      ...
      href: withPrefix('/components/notification'),
    },
    {
      name: 'NumberInput',
      ...
      href: withPrefix('/components/number-input'),
    },
    {
      name: 'PasswordInput',
      ...
      href: withPrefix('/components/password-input'),
    },
    {
      name: 'PhoneInput',
      ...
      href: withPrefix('/components/phone-input'),
    },
    {
      name: 'RadioButton',
      ...
      href: withPrefix('/components/radio-button'),
    },
    {
      name: 'SearchInput',
      ...
      href: withPrefix('/components/search-input'),
    },
    {
      name: 'SelectionGroup',
      ...
      href: withPrefix('/components/selection-group'),
    },
    {
      name: 'SideNavigation',
      ...
      href: withPrefix('/components/side-navigation'),
    },
    {
      name: 'StatusLabel',
      ...
      href: withPrefix('/components/status-label'),
    },
    {
      name: 'Stepper',
      ...
      href: withPrefix('/components/stepper'),
    },
    {
      name: 'Table',
      ...
      href: withPrefix('/components/table'),
    },
    {
      name: 'Tabs',
      ...
      href: withPrefix('/components/tabs'),
    },
    {
      name: 'Tag',
      ...
      href: withPrefix('/components/tag'),
    },
    {
      name: 'TextArea',
      ...
      href: withPrefix('/components/text-area'),
    },
    {
      name: 'TextInput',
      ...
      href: withPrefix('/components/text-input'),
    },
    {
      name: 'TimeInput',
      ...
      href: withPrefix('/components/time-input'),
    },
    {
      name: 'ToggleButton',
      ...
      href: withPrefix('/components/toggle-button'),
    },
    {
      name: 'Tooltip',
      ...
      href: withPrefix('/components/tooltip'),
    },
  ];
