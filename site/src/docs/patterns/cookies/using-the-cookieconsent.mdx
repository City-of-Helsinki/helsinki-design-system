...
If you are looking for technical documentation about the CookieConsent component, please refer to <Link href="/components/cookie-consent">the component page</Link>.

If you are looking for an explanation about gathering and categorising cookies, please refer to <Link href="/patterns/cookies/basics">the Cookie basics page</Link>.
