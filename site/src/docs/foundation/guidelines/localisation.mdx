...
- **The default language of Helsinki digital services is Finnish (FI).**
  - It is recommended that Helsinki digital services follow the Finnish date and time locale even if the user is using some other language. See the [HDS data format guidelines](/foundation/guidelines/data-formats 'HDS data format guidelines') for more information.
- **Content should also be provided at least in Swedish (SV) and English (EN), if possible.**
  ...
  - For the Swedish (SV) locale, the Helsingfors version of the framed logo should be used. Other languages use the default Helsinki framed logo. See more in the [logo guidelines](/foundation/visual-assets/logo 'HDS Visual assets logo guidelines').
