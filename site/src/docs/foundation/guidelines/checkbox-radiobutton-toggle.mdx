...
<LeadParagraph>Helsinki Design System has checkboxes, radio buttons and toggles that might seem similar to each other, but it is important to consider the use cases to decide which one to use.</LeadParagraph>
...
<InternalLink size="M" href="/components/checkbox" >HDS checkbox component documentation</InternalLink>
...
<InternalLink size="M" href="/components/toggle-button">HDS toggle component documentation</InternalLink>
