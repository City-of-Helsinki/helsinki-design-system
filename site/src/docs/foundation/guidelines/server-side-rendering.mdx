...
Critical CSS is the CSS applied to above-the-fold elements. It is the CSS of the immediately visible content in the browser viewport when the user opens your website. Critical CSS does not usually have the styles of the elements that are in the scrollable content outside of the browser viewport. There is one exception though...
