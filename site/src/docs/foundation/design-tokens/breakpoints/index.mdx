...
- Always use token of the same level for both the breakpoint and container width. This ensures consistency across all services using HDS breakpoint tokens. Read more about this in <a href="#using-breakpoint-tokens">the breakpoint usage section.</a>
