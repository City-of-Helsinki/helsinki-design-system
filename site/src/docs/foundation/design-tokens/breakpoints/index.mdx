...
HDS includes tokenized values for both breakpoints and a maximum container width. Breakpoint tokens can be also used alongside <Link size="M" href="/foundation/guidelines/grid">HDS grid guidelines</Link> in order to create consistent designs and implementations.
