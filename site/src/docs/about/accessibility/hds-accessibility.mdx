...
- HDS components allow a lot of customisation. When customising component colours, ensure accessibility. For more information, refer to <Link size="M" href="/foundation/design-tokens/colour#customising-colours">HDS Colours - Customising colours documentation</Link>.
