...
<LeadParagraph>This accessibility statement applies to the Helsinki Design System documentation website. The site address is hds.hel.fi.</LeadParagraph>
...
If a user feels that their report or enquiry has not received a response or that the response is unsatisfactory, they can report the issue to the Finnish Transport and Communication Agency Traficom. The website of the Finnish Transport and Communication Agency Traficom explains in detail how the matter will be processed.

Finnish Transport and Communication Agency Traficom   
Digital Accessibility Supervision Unit  
<ExternalLink href="https://www.webaccessibility.fi">www.webaccessibility.fi</ExternalLink>   
