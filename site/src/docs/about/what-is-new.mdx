...
<LeadParagraph>
    Here you will find summarized patch notes of major releases of HDS. For full patch notes for each release, please refer to the <ExternalLink size="L" href="https://github.com/City-of-Helsinki/helsinki-design-system/releases" >GitHub releases</ExternalLink>.
</LeadParagraph>

## Releases
### 2.4.0

*10.10.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v.2.4.0" external>Release notes</ExternalLink>
...
- **Added**: React CookieModal component
- **Added**: React CookiePage component
- **Added**: New pattern Cookie compliance
- **Added**: New pattern Common Helsinki cookies
- **Added**: New pattern Cookie consent
...
### 2.1.0
*30.6.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v2.1.0" external>Release notes</ExternalLink>

- **Added**: Navigation DropdownLink
- **Fixed**: Dialog unwanted content scrolling

### 2.0.0 
*27.6.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v2.0.0">Release notes</ExternalLink>
...
### 1.15.0
*30.5.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.14.0">Release notes</ExternalLink>
...
### 1.14.0
*5.5.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.14.0">Release notes</ExternalLink>
...
### 1.13.0 
*20.4.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.13.0">Release notes</ExternalLink>

- **Added**: Pagination Core component
- **Fixed**: Dialog re-rendering when content state changes

### 1.12.0 
*22.3.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.12.0">Release notes</ExternalLink>
...
### 1.11.1
*8.3.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.11.1" >Release notes</ExternalLink>

- **Fixed**: Core table header's default background color

### 1.11.0
*23.2.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.11.0" >Release notes</ExternalLink>
...
### 1.10.0
*31.1.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.10.0" >Release notes</ExternalLink>
...
### 1.9.0
*5.1.2022* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.9.0" >Release notes</ExternalLink>
...
### 1.8.0
*9.12.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.8.0" >Release notes</ExternalLink>
...
### 1.7.0
*25.11.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.7.0" >Release notes</ExternalLink>
...
### 1.6.0
*28.10.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.6.0" >Release notes</ExternalLink>
...
### 1.5.0
*22.9.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.5.0" >Release notes</ExternalLink>
...
### 1.4.0
*7.9.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.4.0" >Release notes</ExternalLink>
...
### 1.3.1
*11.8.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.3.1" >Release notes</ExternalLink>
...
### 1.3.0
*9.8.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v.1.3.0" >Release notes</ExternalLink>
...
### 1.2.0
*21.6.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.2.0" >Release notes</ExternalLink>
...
### 1.1.0
*25.5.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.1.0" >Release notes</ExternalLink>
...
### 1.0.0
*3.5.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.0.0" >Release notes</ExternalLink>
...
### 0.25.0 (beta)
*14.4.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.25.0" >Release notes</ExternalLink>
...
### 0.24.0 (beta)
*29.3.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.24.0" >Release notes</ExternalLink>
...
### 0.23.0 (beta)
*12.3.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.23.0" >Release notes</ExternalLink>

- **Added**: Time input to React package
- **Fixed**: Navigation component server-side rendering bug

### 0.22.0 (beta)
*4.3.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.22.0" >Release notes</ExternalLink>

- **Added**: Date input with a date picker to React package
- **Fixed**: Removed unwanted footer border in Safari browser

### 0.21.0 (beta)
*19.1.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.21.0" >Release notes</ExternalLink>
...
### 0.20.0 (beta)
*5.1.2021* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.20.0" >Release notes</ExternalLink>

- **Added**: New component Tabs

### 0.19.0 (beta)
*22.12.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.19.0" >Release notes</ExternalLink>

- **Added**: New component Accordion

### 0.18.0 (beta)
*8.12.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.18.0" >Release notes</ExternalLink>

- **Added**: New component Search field
- **Added**: New pattern Form validation

### 0.17.0 (beta)
*24.11.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.17.0" >Release notes</ExternalLink>
...
### 0.16.0 (beta)
*13.11.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.16.0" >Release notes</ExternalLink>

- **Added**: New components Loading spinner, Selection group, Tag
- **Fixed**: Accessibility issues in the Notification component

### 0.15.0 (beta)
*29.10.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.15.0" >Release notes</ExternalLink>
...
### 0.14.0 (alpha)
*15.10.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.14.0" >Release notes</ExternalLink>
...
### 0.13.0 (alpha)
*1.9.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.13.0" >Release notes</ExternalLink>
...
### 0.12.0 (alpha)
*14.8.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.12.0" >Release notes</ExternalLink>
...
### 0.11.0 (alpha)
*2.6.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.11.0" >Release notes</ExternalLink>
...
### 0.10.0 (alpha)
*26.5.2020* - <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v0.10.0" >Release notes</ExternalLink>
