...
- As dialogs always contain buttons, pay close attention that the button labels describe the action it is going to trigger. You can read more information about this in the <InternalLink href="/components/buttons">HDS Button documentation page.</InternalLink>
