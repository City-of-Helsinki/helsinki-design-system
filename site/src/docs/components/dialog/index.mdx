...
import { Dialog, Button, IconAlertCircle, IconInfoCircle, IconTrash, IconQuestionCircle } from 'hds-react';
...
- If your dialog contains form elements, follow <InternalLink href="/patterns/forms/form-building">HDS form</InternalLink> and <InternalLink href="/patterns/forms/form-validation">form validation patterns</InternalLink> similarly as you would in a regular forms.
- As dialogs always contain buttons, pay close attention that the button labels describe the action it is going to trigger. You can read more information about this in the <InternalLink href="/components/button">HDS Button documentation page.</InternalLink>
