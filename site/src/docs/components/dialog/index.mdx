...
- If your dialog contains form elements, follow [HDS form](/patterns/forms/form-building) and [form validation patterns](/patterns/forms/form-validation) similarly as you would in a regular forms.
