...
import { Button, ButtonVariant, LoadingSpinner, IconAngleRight, IconShare, IconTrash, IconSaveDisketteFill, Notification } from 'hds-react';
...
<PlaygroundPreview style={{ marginTop: 'var(--spacing-m)' }}>
  ...
  <Button iconEnd={<IconAngleRight />} style={{ marginLeft: 'var(--spacing-s)' }}>Button</Button>
  <Button iconStart={<IconShare />} iconEnd={<IconAngleRight />} style={{ marginLeft: 'var(--spacing-s)' }}>Button</Button>
</PlaygroundPreview>
...
<PlaygroundPreview>
  <Button role="link" onClick={() => window.open('/')}>Button</Button>
</PlaygroundPreview>
