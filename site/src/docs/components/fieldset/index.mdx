...
- The Fieldset component should only contain form elements such as input fields and form controls. See [HDS Form pattern documentation](/patterns/forms/form-building) for more information about available form elements.
