...
- The toggle button should have an immediate effect when activated.
  ...
  - If your toggle button does not have an immediate effect, use a single [Checkbox component](/components/checkbox) instead. Also see [guidelines for choosing between radiobuttons, checkboxes and toggles.](/foundation/guidelines/checkbox-radiobutton-toggle)
