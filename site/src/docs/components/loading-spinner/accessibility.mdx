...
### Pay attention to
- The colour contrast between the loading spinner and its background must comply with <ExternalLink href="https://www.w3.org/TR/WCAG21/#contrast-minimum" external>AA Level contrast ratios</ExternalLink>. You can find more information about accessible colour combinations in [Colour design token documentation](/design-tokens/colour).
