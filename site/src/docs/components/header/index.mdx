...
- [With Header.ActionBar](#with-action-bar)
  - [With Header.NavigationLanguageSelector](#with-navigation-language-selector) inside the action bar
...
- The Header.NavigationSearch needs to be inside [Header.ActionBarItem](#actionbaritem). Notice that the ActionBarItem is what is displayed on the ActionBar, and the children inside it are what's in the dropdown.
