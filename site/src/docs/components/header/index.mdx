      ...
      <Header.NavigationLink
        ...
        dropdownLinks={[
          <Header.NavigationLink
            ...
            active
            dropdownLinks={[
              <Header.NavigationLink href="#" label="Deep link 1" />,
              <Header.NavigationLink href="#" label="Deep link 2" />,
              <Header.NavigationLink href="#" label="Deep link 3" />,
            ]}
          />,
          <Header.NavigationLink
            href="#"
...
<PlaygroundPreview>
  <Header>
    <Header.UniversalBar primaryLinkHref="#" primaryLinkText="Helsingin kaupunki">
      <Header.NavigationLink href="#" label="F.A.Q" />
      <Header.NavigationLink href="#" label="User guide" />
    </Header.UniversalBar>
    <Header.ActionBar
      title="Helsingin kaupunki"
      titleHref="https://hel.fi"
