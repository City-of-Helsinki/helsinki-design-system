...
**Note:** Header is designed to be used full width at the top of the page above the main content. Preview here might not scale correctly and mobile navigation menu is disabled. <Link openInNewTab openInNewTabLabel="Opens in a new tab" href="/storybook/react/?path=/story/components-header--minimal">View minimal header example with skip link in Storybook</Link>.
...
- See example for Header.LanguageSelector <Link openInNewTab openInNewTabLabel="Opens in a new tab" href="/storybook/react/?path=/story/components-header--with-full-features">in Storybook</Link>.
...
The Header.Search component integrates the <InternalLink href="/components/search">Search</InternalLink> component into the Header. Clicking the search icon in the action bar opens a full-width dropdown panel with a search input and suggestions. The component uses the same `onSearch` asynchronous function as the standalone Search component.

- Header.Search is placed inside Header.ActionBar as a child component.
- The `texts` prop provides labels for the heading, button, close button, and the inner search input.
- The `onSubmit` callback is called when the user submits a search.
- The `onSearch` callback provides asynchronous search suggestions in the dropdown.
...
**Note:** Header is designed to be used full width at the top of the page above the main content. Preview here might not scale correctly and mobile navigation menu is disabled. <Link openInNewTab openInNewTabLabel="Opens in a new tab" href="/storybook/react/?path=/story/components-header--with-search">View header with search example in Storybook</Link>.
...
**Note:** Header is designed to be used full width at the top of the page above the main content. Preview here might not scale correctly and mobile navigation menu is disabled. <Link openInNewTab openInNewTabLabel="Opens in a new tab" href="/storybook/react/?path=/story/components-header--with-full-features-custom-theme">View full header with custom theme example in Storybook</Link> or toggle <Link openInNewTab openInNewTabLabel="Opens in a new tab" href="/storybook/react/?path=/story/components-header--with-full-features">the dark theme in full featured story</Link>.
