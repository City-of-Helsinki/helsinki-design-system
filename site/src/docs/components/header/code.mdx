      ...
      <Header onDidChangeLanguage={languageChangedStateAction} languages={languages}>
        ...
        >
          <Header.LanguageSelector ariaLabel={I18n.ariaLanguageSelection} languageHeading={I18n.otherLanguages}>
            ...
            <Link external href="www.example.com" size="S" lang="fi">{I18n.clearFinnish}</Link>
            <Link external href="www.example.com" size="S" lang="fse">{I18n.signLanguage}</Link>
...
**Note:** Header is designed to be used full width at the top of the page above the main content. Preview here might not scale correctly and mobile navigation menu is disabled. <Link openInNewTab openInNewTabAriaLabel="Opens in a new tab" href="/storybook/react/?path=/story/components-header--with-full-features-custom-theme">View full header with custom theme example in Storybook</Link>.
...
| `className`                              | Additional class names to apply.          | `string` | -             |
| `id`                                     | Id of the header element.                 | `string` | -             |
...
| [Table 9:Header.ActionBarItem properties] |
...
| `index`                           | Element index given by parent mapping.                                      | `number`          | -                                                       |
| `label`                           | Label for the link.                                                         | `string`          | -                                                       |
| `onDropdownButtonClick`           | Callback fired when the dropdown button is clicked.                         | `() => void`      | -                                                       |
| `openDropdownAriaButtonLabel`     | Aria-label for the dropdown button to describe the opening of the dropdown. | `string`          | -                                                       |
| `openSubNavIndex`                 | Which sub navigation index is open.                                         | `number`          | -                                                       |
| `setOpenSubNavIndex`              | Set which sub navigation index is open.                                     | `number`          | -                                                       |
