    ...
    <>
      <Header>
        ...
        <Header.NavigationMenu>
          <Header.NavigationLink
            ...
            dropdownLinks={[
              <Header.NavigationLink
                ...
                active
                dropdownLinks={[
                  <Header.NavigationLink as={Link} href="#" label="Deep link 1" />,
                  <Header.NavigationLink as={Link} href="#" label="Deep link 2" />,
                  <Header.NavigationLink as={Link} href="#" label="Deep link 3" />,
                ]}
              />,
              <Header.NavigationLink
                as={Link}
          ...
          />
          <Header.NavigationLink as={Link} href="#" label="Link 3" />
        </Header.NavigationMenu>
      </Header>
      <div id="content" />
    </>
