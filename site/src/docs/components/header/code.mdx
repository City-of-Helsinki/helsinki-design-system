...
import { Header, IconSearch, IconUser, IconSignout, Logo, logoFi, logoFiDark, logoSv, logoSvDark } from 'hds-react';
...
| [Table 10:Header.ActionBarSubItem properties] |

| Description                                                                               |     |
| ---------------------------------------------------------------------------------------   | --- |
| Same properties as the Header.ActionBarSubItem. The component sets `IsHeading` to `true`. |
| [Table 11:Header.ActionBarSubItemGroup properties]                                        |
...
| [Table 12:Header.Loginbutton properties]  |
...
| `id`                                             | The id attribute of the element.                          | `string`                        | -                                              |
| `& Header.ActionBarItemButton properties`        | Extends properties of the Header.ActionBarItemButton.     | -                               | -                                              |
| [Table 13:Header.LogoutSubmenuButton properties] |

| Description                                                        |     |
| ------------------------------------------------------------------ | --- |
| No properties to set. User data is picked from the Login Provider. |
| [Table 14:Header.UserMenuButton properties]                        |
