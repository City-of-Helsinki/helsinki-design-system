...
Note! These icons are meant to describe the link target. If you need a directional icon for the link (e.g. an arrow), you should instead use [a supplementary button](/components/buttons#supplementary) with `role="link"`.
