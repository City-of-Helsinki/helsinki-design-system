...
- If a country code must be inputted, a separate <InternalLink href="/components/select#select-single-selection">HDS Select input</InternalLink> should be used alongside the phone number input.
...
If a country code is a required input (or otherwise critical), it should be asked in a separate input using <InternalLink href="/components/select#select-single-selection">HDS Select.</InternalLink>
