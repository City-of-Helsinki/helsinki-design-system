...
- It is also advised to use a <InternalLink href="/components/text-input">TextInput component</InternalLink> instead of SearchInput. <ExternalLink openInNewTab openInNewTabAriaLabel="Opens in a new tab" href="/storybook/core/?path=/story/components-text-input--default">View in Storybook</ExternalLink>.
