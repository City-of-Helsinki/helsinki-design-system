...
In accordions that have very little content the close button does not offer much utility to the user. In these cases the button can be hidden by setting the `closeButton` property as `false`.

<PlaygroundPreview>
  <Accordion heading="How to publish data?" language="en" style={{ maxWidth: '360px' }} closeButton={false}>
    To publish your data, open your profile settings and click the button 'Publish'.
  </Accordion>  
</PlaygroundPreview>
...
HDS Accordion includes three (3) size variants; small, medium, and large. You can use different sizes depending on the screen size or use case. Use the `size` property to alter the size.
...
<PlaygroundPreview>
  ...
  <Accordion headingLevel="6" size={AccordionSize.Small} card border heading="headingLevel 6" language="en" style={{ maxWidth: '360px' }}>
    This is an Accordion with headingLevel 6
  </Accordion>
  <Accordion headingLevel="6" size={AccordionSize.Small} card border heading="headingLevel 6" language="en" style={{ maxWidth: '360px', marginTop: 0, borderTop: 0 }}>
    This is an Accordion with headingLevel 6
  </Accordion>
  <Accordion headingLevel="6" size={AccordionSize.Small} card border heading="headingLevel 6" language="en" style={{ maxWidth: '360px', marginTop: 0, borderTop: 0 }}>
    This is an Accordion with headingLevel 6
