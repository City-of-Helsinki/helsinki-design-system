...
- The FileInput uses an info text element to inform the user about the status of the component. You can read more about the usage of the info text element in the [HDS Form validation pattern documentation page](/patterns/forms/form-validation#3-info-message).
