...
- The accept parameter only checks and allows selecting the correct file types according to the file extension(s) and does not do any in-depth analysis. Any safety and/or other checks should be done on the receiving end if necessary.
