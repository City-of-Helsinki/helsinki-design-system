...
Below are some good practices you need to consider. For more detailed checklist, please refer to <ExternalLink href="https://github.com/City-of-Helsinki/ASVS/blob/helsinki-4.0.1/4.0/en/0x20-V12-Files-Resources.md">Helsinki OWASP Application Security Verification Standard</ExternalLink>.
