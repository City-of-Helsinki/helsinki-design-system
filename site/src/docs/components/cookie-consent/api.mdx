...
You can find examples of ContentSource property contents in <Link openInNewTab openInNewTabAriaLabel="Opens in a new tab" href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--english-modal-version')}>the HDS CookieConsent Storybook examples</Link>.
