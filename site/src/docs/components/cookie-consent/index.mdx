...
<Link openInNewTab openInNewTabAriaLabel="Opens in a new tab" href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--modal-version')}>View modal example in Storybook</Link>
...
<Link openInNewTab openInNewTabAriaLabel="Opens in a new tab" href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--page-version')}>View page example in Storybook</Link>
