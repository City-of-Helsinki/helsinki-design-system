...
<Link href="/storybook/react/?path=/story/components-cookieconsent--modal-version">View modal example in Storybook</Link>
...
<Link href="/storybook/react/?path=/story/components-cookieconsent--page-version">View page example in Storybook</Link>
