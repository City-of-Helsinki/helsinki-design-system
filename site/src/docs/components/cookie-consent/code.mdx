...
<Link
  ...
  href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--english-modal-version')}
>
...
<Link
  openInNewTab
  openInNewTabAriaLabel="Opens in a new tab"
  href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--page-version')}
>
...
| ------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **HDS React** | <div style={{ display: 'flex', gap: 'var(--spacing-3-xs)' }}><IconCheckCircleFill /> Yes </div> | <Link size="M" openInNewTab openInNewTabAriaLabel="Opens in a new tab" href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--english-modal-version')}>View in Storybook</Link> | <Link size="M" external openInExternalDomainAriaLabel="Opens in a new domain" openInNewTab openInNewTabAriaLabel="Opens in a new tab" href="https://github.com/City-of-Helsinki/helsinki-design-system/blob/master/packages/react/src/components/cookieConsent">View source</Link> |
| **HDS Core**  | <div style={{ display: 'flex', gap: 'var(--spacing-3-xs)' }}><IconCrossCircle /> No </div>      | -                                                                                                                                                                                          | -                                                                                                                                                                                                                                                                                  |

### Properties

Note! You can find the full list of properties in the <Link size="M" openInNewTab openInNewTabAriaLabel="Opens in a new tab" href={withPrefix('/storybook/react/?path=/story/components-cookieconsent--english-modal-version')}>React Storybook.</Link>
