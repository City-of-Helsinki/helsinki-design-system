...
- Navigation component is built to follow HDS [breakpoint tokens](/foundation/design-tokens/breakpoints). While it is recommended to follow HDS breakpoint tokens, you may alter navigation width to fit your service's needs.
