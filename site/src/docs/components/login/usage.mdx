...
More detailed information about <AnchorLink>GraphQL module</AnchorLink> and its hooks are listed on the <ApiPageAnchorLink anchor="graphql-module">API page</ApiPageAnchorLink>.
...
Uri for the server. No other requirements unless the query needs authentication.
