...
Uri for the server, ApolloClient and a query document. No other requirements unless the query needs authentication.
...
| `query`                             | `TypedDocumentNode<Q, OperationVariables> or DocumentNode`                                             | ---- .                                                                                                                  | -             |
| `queryHelper`                       | `(current:QueryOptions, apiTokenClient?: ApiTokenClient, beacon?:Beacon)=>QueryOptions`                | ---- .                                                                                                                  | -             |
| `options`                           | ---                                                                                                    | ---- .                                                                                                                  | -             |
| `options.autoFetch`                 | `boolean`                                                                                              | ---- .                                                                                                                  | -             |
| `options.requireApiTokens`          | `boolean`                                                                                              | ---- .                                                                                                                  | -             |
| `options.abortIfLoading`            | `boolean`                                                                                              | ---- .                                                                                                                  | -             |
| `options.keepOldResultOnError`      | `boolean`                                                                                              | ---- .                                                                                                                  | -             |
| `options.apiTokensWaitTime`         | `number`                                                                                               | ---- .                                                                                                                  | -             |
| `options.apiTokenKey`               | `string`                                                                                               | ---- .                                                                                                                  | -             |
...
The following function can be imported and used without the `GraphQL module` module:

| Property                                   | Description         | Argument(s)           | Return value    |
| ------------------------------------------ | ------------------- | --------------------- | --------------- |
| `createGraphQLModule(options)`             | Creates the module. | GraphQLModuleOptions. | `GraphQLModule` |
