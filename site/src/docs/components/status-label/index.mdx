...
<PlaygroundPreview>
  ...
  <StatusLabel type="alert" style={{ marginLeft: 'var(--spacing-s)' }} iconStart={<IconAlertCircle />}>Needs attention</StatusLabel>
  <StatusLabel type="error" style={{ marginLeft: 'var(--spacing-s)' }} iconStart={<IconError />}>Rejected</StatusLabel>
</PlaygroundPreview>
...
<PlaygroundPreview>
  ...
  <StatusLabel type="info" style={{ marginLeft: 'var(--spacing-s)' }} iconStart={<IconInfoCircle />}>Info</StatusLabel>
  <StatusLabel type="success" style={{ marginLeft: 'var(--spacing-s)' }} iconStart={<IconCheckCircle />}>Success</StatusLabel>
  <StatusLabel type="alert" style={{ marginLeft: 'var(--spacing-s)' }} iconStart={<IconAlertCircle />}>Alert</StatusLabel>
  <StatusLabel type="error" style={{ marginLeft: 'var(--spacing-s)' }} iconStart={<IconError />}>Error</StatusLabel>
</PlaygroundPreview>
