...
<Notification label="Breaking change" className="siteNotification" type="alert">
  The default rectangular status labels are deprecated. The rounded cornered variant will replace the default rectangular StatusLabel in the next major release. As a result the RoundedTag and LargeRoundedTag components will be removed and supported within the default StatusLabel component.
</Notification>
