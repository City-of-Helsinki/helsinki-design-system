...
- The button and the link should relate to the step's contents. We recommend to have only one button or a link per step but sometimes it could be reasonable to have two. Before you add a second button or a link though, think whether the step should be divided in two steps.
