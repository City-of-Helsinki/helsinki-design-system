...
- You can find guidelines on when to use each status colour in the [colour guidelines](/foundation/design-tokens/colour#ui-colours 'UI colours'). Aim to use notification levels and colours consistently across your service.
