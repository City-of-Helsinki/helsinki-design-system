...
| `size`                     | The size of the notification.                                                                                               | `string`                                                                                                      | -
| `link`                     | Link under the notification.                                                                                                | `string`                                                                                                      | -
| `linkText`                 | Optional text parameter to be displayed instead of the url.                                                                                        | `NotificationSize` or (`"small"`, `"medium"`, `"large"`)                                                      | `"medium"`       |
