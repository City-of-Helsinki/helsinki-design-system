...
| `link`                     | Link below the notification content. Always renders as `medium` size.                                                       | <Link openInNewTab openInNewTabAriaLabel="Opens in a new tab" href="/components/link/">`Link`</Link>          | -                |
