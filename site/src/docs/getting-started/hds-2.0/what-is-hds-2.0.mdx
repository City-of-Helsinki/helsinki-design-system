...
Reading this article will help you understand what has been changed in the HDS 2.0 update and how it will affect your project. If you are looking for a guide for migrating from HDS 1.X to 2.0, please refer to our <InternalLink href="/getting-started/hds-2.0/migrating-to-2.0">2.0 migration guide.</InternalLink>
...
To learn about the typography changes in greater detail, please refer to the <InternalLink href="/getting-started/hds-2.0/migrating-to-2.0">HDS 2.0 migration guide.</InternalLink>
...
The changes Hel.fi project has done to the <InternalLink href="/components/accordion">Accordion component</InternalLink> have been brought to HDS. The accordion now supports an optional close button that will appear at the bottom of an expanded accordion. The component now also features three (3) size variants.
