...
<Image src="/images/getting-started/hds-2.0/typography-before-after.png" alt="Typography - Before and after images" style="display:block;width:100%;min-width:600px;max-width:915px;margin:0 auto;" viewable />
...
<Image src="/images/getting-started/hds-2.0/accordion-before-after.png" alt="Accordion - Before and after images" style="display:block;width:100%;min-width:600px;max-width:915px;margin:0 auto;" viewable />
...
<Image src="/images/getting-started/hds-2.0/container-before-after.png" alt="Container - Before and after images" style="display:block;width:100%;min-width:600px;max-width:915px;margin:0 auto;" viewable />
...
<ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v2.0.0">Read the full changelog in the HDS GitHub page</ExternalLink>
...
Looking for HDS V1 documentation? Find it here: <ExternalLink href="https://hds.hel.fi/v1" openInNewTab>HDS V1 documentation</ExternalLink>.
...
1. Install the <ExternalLink href="https://ashung.github.io/Automate-Sketch/">Automate plugin</ExternalLink> to your Sketch.
2. Remove linked HDS libraries from your project in Abstract.
3. Link <ExternalLink href="https://share.goabstract.com/e0a49189-f9f7-470f-956b-c7217b576fb0">HDS v1 libraries</ExternalLink> to your project in Abstract. Take a look at our <Link href="getting-started/tutorials/abstract-tutorial#how-to-link-hds-libraries-to-a-project">Abstract tutorial</Link> if you need more info about linking libraries.
...
An alternative method is to <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/releases">download a specific HDS version design kit from the release list</ExternalLink>. This is not recommended if your project is used via Abstract.

## How HDS will be versioned in the future?
The HDS versioning will stay the same after the 2.0 update. We will follow <ExternalLink href="https://semver.org/">semantic versioning</ExternalLink> and breaking changes can only be introduced in major releases. However, we are planning to release major releases more often in the future. The next major release, HDS 3.0, is currently planned to be released in autumn 2022.
