...
Please refer to the [Breakpoint token documentation page to learn more](/foundation/design-tokens/breakpoints). Also check out the <Link openInNewTab openInNewTabAriaLabel="Opens in a new tab" size="M" href="/storybook/react/?path=/story/components-container--example">HDS Container component</Link> which makes it easy to follow breakpoint and container width tokens.
