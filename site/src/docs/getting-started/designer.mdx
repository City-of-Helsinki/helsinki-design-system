...
4. If you have an idea for improvements or a component that could be a useful addition to the Design System, see the <InternalLink href="/getting-started/contributing/before-contributing">Contributing</InternalLink> page for more information.
