...
<Accordion 
  ...
  <ol>
    <li><b>Reorganise your files.</b> This means creating multiple smaller files from one larger file. If many of your files use the same components, create one file to hold those components and use that file as a library. Read more about creating library files in the <ExternalLink
    ...
    >Abstract’s documentation.</ExternalLink></li>
