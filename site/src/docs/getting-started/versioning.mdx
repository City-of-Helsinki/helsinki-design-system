...
- if released component is removed completely
...
- changes in component box model affecting how the components align with each other or the width of the element
