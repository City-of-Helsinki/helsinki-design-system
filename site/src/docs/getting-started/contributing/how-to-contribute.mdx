...
* <InternalLink href="/about/#contact">Contact</InternalLink> HDS team to see how we can help
* Propose a new component, pattern, or update to the documentation
* Give feedback and report bugs
* Send a <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/pulls">pull request</ExternalLink>
...
More detailed guide for developers can be found in <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/CONTRIBUTING.md">HDS Github repository</ExternalLink>.
