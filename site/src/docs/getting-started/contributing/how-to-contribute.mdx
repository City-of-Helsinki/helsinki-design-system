...
<LeadParagraph>  You can contribute to the HDS in many ways. Before you start contributing to HDS, read the following guide so we can make the most out of your contribution.</LeadParagraph>
...
<Image src="/images/getting-started/contributing-design/hds-contribution.png" alt="How to contribute to Helsinki Design System" style={{ display: 'block', width: '100%', minWidth: 600, maxWidth: 915, margin: '0 auto' }} viewable />
