...
<LeadParagraph>  Documentation is an essential part of HDS. In addition to component-specific documentation, HDS provides broader guidelines, instructions, and patterns for creating City of Helsinki digital services.</LeadParagraph>
...
Parts of the HDS documentation have been written with the assistance of AI tools. All AI-generated and AI-assisted content is reviewed, edited, and verified by the HDS team to ensure accuracy and consistency with the design system.
