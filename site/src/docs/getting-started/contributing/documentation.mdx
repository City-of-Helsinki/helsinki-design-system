...
- Documentation site styles take care of most of the accessibility issues. You mostly need to ensure that heading levels are used semantically (refer to <InternalLink href="/foundation/design-tokens/typography">HDS typography documentation</InternalLink>) and external links are correctly visualized (you can use the HDS provided <ExternalLink href="https://github.com/City-of-Helsinki/helsinki-design-system/blob/master/site/src/components/Link.js">Link component</ExternalLink>.
