...
A mask customizes the container of an icon from the default square canvas. They also work great for testing different design ideas without having to commit to certain dimensions or layouts. Masks may be embedded in the asset itself or applied afterwards. Masks should always be flattened before exporting the icon asset.
...
eg. The human eye (or the brain) is more tuned to seeing contrast in horizontal lines than vertical, so one should sometimes consider beefing up vertical lines.
...
## Icon grid
> **Example: A typical icon grid used for making icons.**
...
## Safe area & trim area
<Image src="../../static/assets/image/safearea_trimarea.jpg" alt="The difference between safe area and trim area explained." style="max-width:600px;" viewable />
