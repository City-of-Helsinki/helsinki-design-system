...
<p> 
  For more information see the <Link href="https://github.com/ronijaakkola/hds-assistant" external>HDS Assistant Github page</Link>. You can also <Link href="sketch://add-assistant?url=https://github.com/ronijaakkola/hds-assistant/releases/latest/download/hds-assistant.tgz" external>add HDS Assistant directly to Sketch by pressing this link</Link>.
</p>
