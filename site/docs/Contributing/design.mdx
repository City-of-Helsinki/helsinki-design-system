...
<p> 
    <Link href="sketch://add-assistant?url=https://github.com/ronijaakkola/hds-assistant/releases/latest/download/hds-assistant.tgz" external> Install the HDS assistant directly to currently open Sketch file.</Link>
</p>
