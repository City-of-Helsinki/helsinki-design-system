...
import { AlertCircle } from "hds-react";
...
<p>
    HDS design versions are managed in City of Helsinki Abstract, in a project called <Link href="https://share.goabstract.com/4be1120f-5c64-4937-9a56-0484b26e20d7" external>Helsinki Design System</Link>.
</p> 
<p>
    The design assets are also available as a design kit package which is downloadable from the official <Link href="https://github.com/City-of-Helsinki/helsinki-design-system/releases" external>HDS repository releases</Link>.
</p>
...
<p>If you do not have an access to City of Helsinki Abstract and HDS repository, you can create an issue in <Link href="https://github.com/City-of-Helsinki/helsinki-design-system" external>HDS GitHub repository</Link>. </p>
...
When designing together, things tend to get messy. Here's some guidelines and tips that help us keep HDS library files clean, consistent and easy to use for all.
...
> <Image src="../../static/contributing-sketch-symbol-type.png" alt="Two levels of types in Colour *category" style="max-width:250px;" viewable />
...
- ***(Additional information)*** can be added in the end of the name within parentheses `( )`. For example the specific pixel size of a spacing token.

> **Example: + modifiers used for additional features**
> <Image src="../../static/contributing-sketch-symbol-modifiers.png" alt="+ modifiers used for additional features" style="max-width:200px" viewable />

> **Example: additional info about spacing token pixel values**
> <Image src="../../static/contributing-sketch-symbol-additional.png" alt="additional info about spacing token pixel values" style="max-width:200px" viewable />
...
> <Image src="../../static/contributing-sketch-symbol-parts-sections.png" alt="x_Parts, x_Sections and xx_Deprecated folders on HDS Footer" style="max-width:200px" viewable />
...
> <Image src="../../static/contributing-sketch-pages-single.png" alt="Page structure of a single component library" style="max-width:230px" viewable />

> **Example: pages in a multi component library *HDS Form fields***
> <Image src="../../static/contributing-sketch-pages-multi.png" alt="Page structure of a multi component library" style="max-width:230px" viewable />
...
> <Image src="../../static/contributing-sketch-layer-prefix.png" alt="Emoji prefixes in HDS Footer layer names" style="max-width:230px" viewable />
...
> <Image src="../../static/contributing-sketch-symbol-variants.png" alt="Colour theme and breakpoint variants of footer" style="max-width:230px" viewable />
...
> <Image src="../../static/contributing-sketch-symbol-sorting.png" alt="Sorting variants in HDS Tpography" style="max-width:180px" viewable />


---

## Quality assurance checklist 
With the following checklist you can check your design files before merging them to HDS master.
...
<p> 
    For more informationb see the <Link href="https://github.com/ronijaakkola/hds-assistant" external>HDS Assistant Github page</Link>. You can also <Link href="sketch://add-assistant?url=https://github.com/ronijaakkola/hds-assistant/releases/latest/download/hds-assistant.tgz" external>download and install the HDS assistant</Link> directly to currently open Sketch file.
</p>
