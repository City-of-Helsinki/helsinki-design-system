...
Note, that new feature request and proposed designs are first evaluated and prioritised on HDS roadmap, so the process of adding component to HDS can take a while. If the need for a feature is urgent, discuss this with HDS team.
