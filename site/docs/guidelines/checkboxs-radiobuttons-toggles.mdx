...
import { Notification, Checkbox, RadioButton, Toggle, SelectionGroup } from "hds-react";
...
<LargeParagraph>
    Helsinki Design System has checkboxes, radiobuttons and toggles that might seem similar to each other, but it is important to consider the use cases to decide which one to use.
</LargeParagraph>
...
<br /><br />
<b>Use radiobuttons</b> to mutually exclusive options.
<br /><br />
...
<Link href="../components/radio-button" >HDS radiobutton component</Link>
<br /><br />
...
< br/><br />
<b>Example use:</b> Binary choices like YES/NO, agegroup (0-7, 8-16, over 65 etc) or other similar choices that exclude other options.
<Playground>
    {() => {
