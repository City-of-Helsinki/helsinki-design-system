...
- **Use language code (`FI`, `SV`, `EN`...) to represent locales**
  ...
  - When Listing languages for selection it is advised to also write out the in which language the locale is, in corresponding language. Here are some common example locales:
