...
<Image src="../../static/grid-breakpoint-demonstration.png" alt="Breakpoint demonstration" style="max-width:100%" />
...
<Image src="../../static/grid-layout-columns.png" alt="Dividing columns to smaller columns" style="max-width:100%" />
...
<Image src="../../static/grid-column-stacking.png" alt="When breakpoint changes, columns will stack to the next row starting from left" style="max-width:100%" />
