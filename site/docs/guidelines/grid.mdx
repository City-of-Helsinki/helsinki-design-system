...
The following table presents how HDS grid behaves and changes in different breakpoints. Maximum container width, the number of columns and gutter size alter between breakpoints. You can read more about breakpoint and container width tokens [here](/design-tokens/breakpoints#tokens).
