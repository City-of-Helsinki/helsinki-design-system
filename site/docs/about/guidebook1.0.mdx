...
**Should I use Select or Combobox?** Dropdown component was split in to two different components, Select and Combobox, and old dropdown was marked deprecated in October 2020.
