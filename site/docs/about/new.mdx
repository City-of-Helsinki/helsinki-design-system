...
<p><strong>1.4.1</strong> - <em>9.9.2021</em> - <Link href="https://github.com/City-of-Helsinki/helsinki-design-system/releases/tag/v1.4.1" external>Release notes</Link></p>

- **Fixed**: Invalid CSS generating problems with testing libraries
