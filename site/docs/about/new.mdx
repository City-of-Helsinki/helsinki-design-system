...
- **Added**: Support for placeholder in Search Input
- **Added**: WP and Drupal notes to the developers’ Getting Started documentation
- **Added**: An example of asking the user’s gender in a form to the Form pattern documentation
- **Fixed**: Resolved critical security threats in new documentation site
