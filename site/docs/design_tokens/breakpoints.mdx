...
## Principles
- **Always use token of the same level for both the breakpoint and container width**. This ensures consistency across all services using HDS breakpoint tokens. Read more about this in [Usage](/design-tokens/breakpoints#usage).
...
## Accessibility
- When testing your designs and implementation at different breakpoints, pay extra attention how your service behaves if browser zoom functionality is used. Read more about the [WCAG requirements considering reflow](https://www.w3.org/WAI/WCAG21/Understanding/reflow.html).
