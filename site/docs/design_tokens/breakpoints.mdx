...
**HDS offers a Container component which follows breakpoint and container width tokens automatically.** It is recommended to use it if possible. For more info and examples, see [Container - React documentation](/storybook/react/?path=/story/components-container--exampled) and [Container - Core documentation](/storybook/core/?path=/story/components-container--default).
