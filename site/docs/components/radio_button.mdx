...
- If the choices are not mutually exclusive, use [HDS Checkbox](/components/checkbox) component instead. Also see [guidelines for choosing between radiobuttons, checkboxes and toggles.](/guidelines/checkboxs-radiobuttons-toggles)
