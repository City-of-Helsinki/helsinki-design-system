...
If you have multiple accordions one below another or a lot of accordions in the same view, consider using the visually more light [default styling variant](#default-accordion) instead of this one.
