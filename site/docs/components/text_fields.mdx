...
import "hds-core/lib/components/text-inputs.css";
...
[Text inputs in hds-core](/core/examples/text-inputs.html)  
[Text inputs in hds-react](/storybook/?path=/story/textinput--default)
...
<Playground>
  <div class="hds-text-input">
    <label for="my-input" class="hds-text-input__label text-sm text-bold">
      label
    </label>
    ...
    <span class="hds-text-input__helper-text text-sm">helper text</span>
  </div>
</Playground>
...
_Text field tooltips are only in hds-react!_
