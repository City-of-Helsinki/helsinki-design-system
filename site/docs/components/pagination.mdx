...
- The HDS pagination component supports truncation. This means hiding part of the pages with the "..." (ellipsis) element.
  - Truncation is recommended if your page numbers start to spread into multiple rows.
...
- **Use pages when**
  - the amount of items in one view exceeds 40 items
...
- **Use dynamic loading when**
  - the amount of items in one view is less than 40
...
<div class="hds-pagination-container">
  <nav class="hds-pagination" role="navigation" aria-label="Pagination" data-next="Next">
    ...
    <ul class="hds-pagination__pages">
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=1" title="Go to page 1" aria-label="Page 1">
          1
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=2" title="Go to page 2" aria-label="Page 2">
          2
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link hds-pagination__item-link--active" href="?path=/story/${context.id}&page=3" title="Current page" aria-label="Page 3" aria-current="page">
          3
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=4" title="Go to page 4" aria-label="Page 4">
          4
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=5" title="Go to page 5" aria-label="Page 5">
          5
        </a>
      </li>
      <li>
      ...
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=68" aria-label="Page 68" title="Go to page 68">
          68
        </a>
      </li>
    </ul>
...
<div class="hds-pagination-container">
  <nav class="hds-pagination" role="navigation" aria-label="Pagination" data-next="Next">
    ...
    <ul class="hds-pagination__pages">
      ...
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=30" aria-label="Page 30" title="Go to page 30">
          30
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=31" aria-label="Page 31" title="Go to page 31">
          31
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link hds-pagination__item-link--active" href="?path=/story/${context.id}&page=32" aria-label="Page 32" title="Current page" aria-current="page">
          32
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=33" aria-label="Page 33" title="Go to page 33">
          33
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=34" aria-label="Page 34" title="Go to page 34">
          34
        </a>
      </li>
      <li>
...
<div class="hds-pagination-container">
  <nav class="hds-pagination" role="navigation" aria-label="Pagination" data-next="Next">
    ...
    <ul class="hds-pagination__pages">
      ...
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=64" aria-label="Page 64" title="Go to page 64">
          64
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=65" aria-label="Page 65" title="Go to page 65">
          65
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link hds-pagination__item-link--active" href="?path=/story/${context.id}&page=66" aria-label="Page 66" title="Current page" aria-current="page">
          66
        </a>
      </li>
      <li>
        <a class="hds-pagination__item-link" href="?path=/story/${context.id}&page=67" aria-label="Page 67" title="Go to page 67">
          67
        </a>
      </li>
      <li>
