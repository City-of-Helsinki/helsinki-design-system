...
Pay attention to colour contrast. The active tab accent line has to have at least contrast of `3:1` and the tab text `4.5:1`. Not all brand colours can be used as a text colour and in this case, use `color-black-90` as the text colour and your chosen brand as the accent line colour.,
