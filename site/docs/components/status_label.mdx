...
import { IconInfoCircle, IconCheckCircle, StatusLabel } from "hds-react";
...
<Playground>
    ...
    <StatusLabel style={{marginLeft: 'var(--spacing-s)'}} iconLeft={<IconInfoCircle />}>Default</StatusLabel>
    ...
    <StatusLabel type="alert" style={{marginLeft: 'var(--spacing-s)'}} iconLeft={<IconInfoCircle />}>Alert</StatusLabel>
    <StatusLabel type="error" style={{marginLeft: 'var(--spacing-s)'}} iconLeft={<IconInfoCircle />}>Error</StatusLabel>
</Playground>
...
<StatusLabel type="alert" iconLeft={<IconInfoCircle />}>Alert</StatusLabel>
<StatusLabel type="error" iconLeft={<IconInfoCircle />}>Error</StatusLabel>
```
