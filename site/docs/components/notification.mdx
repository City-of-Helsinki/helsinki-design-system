...
<Playground>
    <Notification size="default" label="New messages">You have received new messages.</Notification>
    <Notification size="default" label="Form done" type="success">Form submit was successful!</Notification>
    <Notification size="default" label="Slow loading" type="alert">Loading is taking longer than expected.</Notification>
    <Notification size="default" label="Missing information" type="error">Form is missing critical information.</Notification>

    <Notification size="small" label="New messages">You have received new messages.</Notification>
    <Notification size="small" label="Form done" type="success">Form submit was successful!</Notification>
    <Notification size="small" label="Slow loading" type="alert">Loading is taking longer than expected.</Notification>
    <Notification size="small" label="Missing information" type="error">Form is missing critical information.</Notification>
</Playground>
...
### Notification sizes
HDS notifications come in three different sizes, allowing the designer to choose 
