...
-->
### Standalone
These links are the default link variant. They are used on their own or directly following content and they are underlined. They can be paired with an icon.
...
### Inline
Inline links are used within a sentence or paragraph and are underlined. Links that open new tabs, windows or otherwise lead to other sites should be followed by the external link icon. Inline links leading to a page within the service should not be paired with an icon.
