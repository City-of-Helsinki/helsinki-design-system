...
### Standalone
Standalone links are used on their own or directly following content, and they are underlined. If you wish not to have an underline, consider using a button instead.
