...
- If your table includes actions that can affect multiple rows (e.g. deleting selected rows or exporting an CSV file), these actions must be placed above the table. For more information, see [Selecting rows]() and [Custom actions]() variant examples below.
