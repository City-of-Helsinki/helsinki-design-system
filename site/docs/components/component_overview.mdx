...
Status                                               | Description
-----------------------------------------------------|--------------
<StatusLabel type="alert">Pre-release</StatusLabel>  | Component is open for feedback. It has been released/changed recently and we are monitoring if it needs fixes. **Be cautious of using in production** because breaking changes are still possible.
<StatusLabel type="info">Stable</StatusLabel>        | Component's implementation, design and documentation are stable. **These components can be used in production.** If there are any breaking changes that cannot be avoided, the major version number is increased and the aim is to communicate these changes as early as possible. Enhancements are also possible without breaking changes.
...
[Date input](/components/date-input)                             | <StatusLabel type="alert">Pre-release</StatusLabel>  |                                                                               | [<IconCheck/>](/storybook/react/?path=/story/components-dateinput--default)
[Dialog](/components/dialog)                                     | <StatusLabel type="alert">Pre-release</StatusLabel>  |                                                                               | [<IconCheck/>](/storybook/react/?path=/story/components-dialog--default)
Dropdown                                                         | <StatusLabel type="error">Deprecated</StatusLabel>   |                                                                               |
[Footer](/components/footer)                                     | <StatusLabel type="alert">Stable</StatusLabel>  |                                                                               | [<IconCheck/>](/storybook/react/?path=/story/components-footer--default)
...
[Number input](/components/number-input)                         | <StatusLabel type="alert">Pre-release</StatusLabel>  | [<IconCheck/>](/storybook/core/?path=/story/components-number-input--default) | [<IconCheck/>](/storybook/react/?path=/story/components-number-input--default)
...
[Phone input](/components/phone-input)                           | <StatusLabel type="alert">Pre-release</StatusLabel>  | [<IconCheck/>](/storybook/core/?path=/story/components-phone-input--default)  | [<IconCheck/>](/storybook/react/?path=/story/components-phoneinput--default)
...
[Search input](/components/search-input)                         | <StatusLabel type="alert">Pre-release</StatusLabel>  | [<IconCheck/>](/storybook/core/?path=/story/components-search-input--default) | [<IconCheck/>](/storybook/react/?path=/story/components-searchinput--default)
...
[Search input](/components/search-input)                         | <StatusLabel type="alert">Pre-release</StatusLabel>  |                                                                               | [<IconCheck/>](/storybook/react/?path=/story/components-searchinput--default)
...
[Time input](/components/time-input)                             | <StatusLabel type="alert">Pre-release</StatusLabel>  |                                                                               | [<IconCheck/>](/storybook/react/?path=/story/components-timeinput--default)
