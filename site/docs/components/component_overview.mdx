...
[View hds-core in npm](https://www.npmjs.com/package/hds-core)
...
[View hds-react in GitHub](https://www.npmjs.com/package/hds-react)

## Component status

Since HDS is still in alpha stages, the component libraries are still experimental. The existing components can be used in projects but changes may still occur.
...
Notification                                                     | Experimental | [✔](/storybook/core/?path=/story/notification--default) | [✔](/storybook/react/?path=/story/components-notification--default)
