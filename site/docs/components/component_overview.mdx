...
<StatusLabel type="info">Stable</StatusLabel>        | Component's implementation, design and documentation are stable and fully featured. **These components can be used in production.** **In the beta stage we reserve a possibility to do breaking changes to stable components but this is unlikely!** 
