...
<StatusLabel type="info">Stable</StatusLabel>        | Component's implementation, design and documentation are stable and fully featured. **These components can be used in production.** If there are any breaking changes that cannot be avoided, the major version number is increased and the aim is to communicate these changes as early as possible.
...
[Loading spinner](/components/spinner)                           | <StatusLabel type="alert">Pre-release</StatusLabel>  | [<IconCheck/>](/storybook/core/?path=/story/components-loading-spinner--default) | [<IconCheck/>](/storybook/react/?path=/story/components-loadingspinner--default)
...
[Tabs](/components/tabs)                                         | <StatusLabel type="alert">Pre-release</StatusLabel>  |                                                                               | [<IconCheck/>](/storybook/react/?path=/story/components-tabs--default)
