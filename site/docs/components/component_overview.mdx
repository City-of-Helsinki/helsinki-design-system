...
[Selection group](/components/selection-group)                   | <StatusLabel type="alert">Pre-release</StatusLabel>  | [<IconCheck/>](/storybook/core/?path=/story/components-selection-group--default) | [<IconCheck/>](/storybook/react/?path=/story/components-selectiongroup--default)
