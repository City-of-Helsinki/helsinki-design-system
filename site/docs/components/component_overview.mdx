...
[Radio button](/components/radio-button)                         | <StatusLabel type="info">Stable</StatusLabel>        | [<IconCheck/>](/storybook/core/?path=/story/components-radiobutton--default)  | [<IconCheck/>](/storybook/react/?path=/story/components-radiobutton--default)
