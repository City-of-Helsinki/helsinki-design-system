...
- The colour contrast between the Card and its background must comply with <Link href="https://www.w3.org/TR/WCAG21/#contrast-minimum" external>WCAG AA Level contrast ratios</Link>. If needed, you may use a Card border to increase the Card contrast to its background.
