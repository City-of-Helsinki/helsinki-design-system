...
### Dense
The dense Koro variant introduces a smaller wave size with the same shapes. You can choose either the Default or the Dense variant for your project. Read more about Koro usage on the [HDS Visual Assets - Koros page](/visual-assets/koros).

<Playground>
  <Koros dense type="basic" />
  <br />
