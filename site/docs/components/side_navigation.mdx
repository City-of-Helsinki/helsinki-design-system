...
<LargeParagraph>
  A side navigation is an additional navigation element which is located at the left-hand side of the viewport. It provides an extra level of navigation and also can be helpful in situations where the traditional top navigation feels too clumsy.
</LargeParagraph>
...
- **Do use the Side navigation when**
  ...
  - the user needs to be able to easily scan through and navigate between pages of a specific level
  - your main navigation has too many items (TODO)
- **Don't use the Side navigation when**
  - you need space for your content (the side navigation chunks away a large portion of the content area)
  - your service has a low amount of navigation items (TODO)
