...
- If you use both main (top) and side navigation, do not repeat same navigation items in both of them.
...
The default side navigation has a support for two (2) levels of navigation, icons, external links and a divider to create logical groups for the navigation items.
