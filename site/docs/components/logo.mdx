...
<Playground>
    ...
    <Logo language="ru" size="large" style={{marginLeft: 'var(--spacing-s)'}}/>
</Playground>
...
<Playground>
    ...
    <Logo language="sv" size="large" style={{marginLeft: 'var(--spacing-s)'}}/>
    < br />
    <Logo language="ru" size="small" />
    <Logo language="ru" size="medium" style={{marginLeft: 'var(--spacing-s)'}}/>
    <Logo language="ru" size="large" style={{marginLeft: 'var(--spacing-s)'}}/>
</Playground>
