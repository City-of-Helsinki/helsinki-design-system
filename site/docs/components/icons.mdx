...
## Accessibility
- A text alternative must always be provided for icons using the WAI-ARIA defintion _aria-label_ or _aria-labelledby_. See [WCAG Text Alternatives guideline](https://www.w3.org/TR/WCAG20/#text-equiv-all "WCAG 2.0 Text Alternatives") for more information.
