...
<p>The City of Helsinki logo consists of the text <i>Helsinki</i> framed by the shape derived from the city crest. The logo must be used in accordance with the <Link href="https://brand.hel.fi/en/logo" external>Visual Identity Guidelines - Logo</Link>.</p>
