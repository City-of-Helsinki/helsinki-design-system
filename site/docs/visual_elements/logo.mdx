...
The City of Helsinki logo consists of the text _Helsinki_ framed by the shape derived from the city crest. The logo must be used in accordance with [the Visual Identity Guidelines for logo](https://brand.hel.fi/en/logo/ "City of Helsinki Visual Identity Guidelines / Logo").
