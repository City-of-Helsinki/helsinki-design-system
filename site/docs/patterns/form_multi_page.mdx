...
One of the main benefits of dividing the form into multiple steps is that the users will make fewer errors in general and the errors will be easier to correct. To read more about form validation in general, please refer to [HDS Form validation pattern documentation](/patterns/form-validation). 
