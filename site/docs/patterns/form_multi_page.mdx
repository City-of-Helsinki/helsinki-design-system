...
<div class="guideline-do" style="background: var(--color-success-light); padding: var(--spacing-s); margin-bottom: var(--spacing-layout-2-xs); max-width:600px;">
    ...
    <ul style="margin-bottom:0;">
        ...
        <li>When the form page changes, <strong>move the browser focus to the step heading.</strong> If you use the step heading provided by the <Link href="/components/stepper">HDS Stepper component</Link>, this will be done automatically for you.</li>
