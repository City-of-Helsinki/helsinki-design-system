...
- <Link href="https://www.sketch.com/" external>Sketch</Link> is a <b>vector graphics editor</b> and is widely adopted by designers to create user interface designs for web and mobile services.
- <Link href="https://www.abstract.com/" external>Abstract</Link> is a <b>design collaboration and version and managegement tool</b> that enables designers to share Sketch files and libraries easily. By leveraging and extends the technology of Git, Abstract provides design teams with a lightweight workflow and stable tools so designers can work together with confidence.
...
<p><b>Note! Library versions in Abstract are considered development versions. They can change and things may be unstable.</b> Using libraries from Abstract allows you to get your hands also on the newest components that are not released yet. If you need more reliable libraries, follow the instructions of option 1. above to download latest stable <Link href="https://github.com/City-of-Helsinki/helsinki-design-system/releases" external>HDS design kit release</Link>.</p>
