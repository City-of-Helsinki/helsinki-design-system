...
1. Head over to [HDS GitHub repository releases](https://github.com/City-of-Helsinki/helsinki-design-system/releases).
...
1. From the top of the file list, select _Add File > Link Library…_  
2. Select the _Helsinki Design System project_  
3. Select one or multiple HDS Libraries and click _Link Libraries_
