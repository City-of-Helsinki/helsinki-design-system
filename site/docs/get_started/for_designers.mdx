...
<Image src="../../static/fordesigners-abstract-link-libraries.png " alt="Linking HDS master libraries" style="max-width:100%" viewable/>

<Image src="../../static/fordesigners-abstract-link-libraries-2.png " alt="Selecting Helsinki Design System libraries from the list" style="max-width:100%" viewable/>
...
<Image src="../../static/fordesigners-hds-master-files.png" alt="Using HDS master library files" style="max-width:100%" viewable/>
...
<Image src="../../static/fordesigners-component-textfield-insert.png" alt="Inserting TextInput component from Sketch Insert menu" style="max-width:100%" viewable/>
...
<Image src="../../static/fordesigners-component-insert.png" alt="Inserting component from Components tab" style="max-width:100%" />
...
<Image src="../../static/fordesigners-component-overrides.png" alt="Customising symbol overrides" style="max-width:100%" viewable/>
...
<Image src="../../static/fordesigners-typography-header-insert.png" alt="Inserting header styles" style="max-width:100%" viewable/>
...
<Image src="../../static/fordesigners-typography-textstyle-appearance.png" alt="Changing text elements style" style="max-width:100%" viewable/>
