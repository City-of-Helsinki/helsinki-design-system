...
<p>If you already are part of the City of Helsinki organization but missing the Contributor role, ask the city of Helsinki representative of your project to fill out the <Link href="https://forms.office.com/r/ebx0YFYspB" external>Abstract invite form</Link> for you (requires Helsinki AD credentials).</p>
...
<p>First, you need to register to Abstract. You can do that on the <Link href="https://app.abstract.com/signup" external>Abstract sign up page</Link>. You may use any email address you like, for example, the email of your organisation.</p>
